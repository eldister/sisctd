...
namespace BESisCtd
{
    public class BE_T_Oficina
    {
        ...
        /// Initializes a new instance of the T_Oficina class.
        /// </summary>
        public BE_T_Oficina(string idCliente, string idoficina, string descripcion, string idubigeo, string direccion, bool estado, DateTime fechaRegistro, string horaRegistro, string usuarioRegistro)
        {
