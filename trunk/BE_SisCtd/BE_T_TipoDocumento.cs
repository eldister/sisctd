...
namespace BESisCtd
{
	public class BE_T_TipoDocumento
	{
		...
		/// Initializes a new instance of the T_TipoDocumento class.
		/// </summary>
        public BE_T_TipoDocumento(string idCliente, string idTipoDocumento, string descripcion, string descripcionLarga, bool verificable, bool critico, bool digitalizable, string nivel, bool estado, int orden, DateTime fechaRegistro, string horaRegistro, string usuarioRegistro)
		{
