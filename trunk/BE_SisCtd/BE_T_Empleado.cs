...
namespace BESisCtd
{
	public class BE_T_Empleado
	{
		...
		/// Initializes a new instance of the T_Empleado class.
		/// </summary>
        public BE_T_Empleado(string idCliente, string idEmpleado, string nombre, string idArea, string idPosicion, bool estado, DateTime fechaRegistro, string horaRegistro, string usuarioRegistro)
		{
