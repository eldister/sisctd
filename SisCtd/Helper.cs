...
namespace SisCtd
{
    public class Helper
    {
        ...
        public static DataTable fDatatable(string sSql)
        {
            ...
            try
            {
                SqlDataReader Dr = SqlHelper.ExecuteReader(Helper.sConexion, CommandType.Text, sSql);
        ...
        public static DataTable fDatatable(string sStore, params object[] pValores)
        {
            ...
            try
            {
                SqlDataReader Dr = SqlHelper.ExecuteReader(Helper.sConexion, sStore, pValores);
                Dt.Load(Dr); Dr.Close(); Dr.Dispose();
                return Dt;
            }
            catch (Exception ex) { throw ex; }
        ...
        public static object fEscalar(string sStore, params object[] pValores)
        {
            try
            {
                return SqlHelper.ExecuteScalar(Helper.sConexion, sStore, pValores);
            }
            catch (Exception ex) { throw ex; }
        }
        public static object fEscalar(string sSql)
        {
            try
            {
                return SqlHelper.ExecuteScalar(Helper.sConexion, CommandType.Text, sSql);
            }
            catch (Exception ex) { throw ex; }
        }
        public static object fEscalar_Cn(string sCn, string sSql)
        {
            try
            {
                return SqlHelper.ExecuteScalar(sCn, CommandType.Text, sSql);
            }
            catch (Exception ex) { throw ex; }
        }
        public static void fExecute(string sStore, params object[] pValores)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(Helper.sConexion, sStore, pValores);
            }
            catch (Exception ex) { throw ex; }
        }
        public static void fExecute(string sSql)
        {
            try
            {
                SqlHelper.ExecuteNonQuery(Helper.sConexion, CommandType.Text, sSql);
            }
            catch (Exception ex) { throw ex; }
        }
